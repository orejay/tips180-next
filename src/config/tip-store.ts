...
export const tipCategories: TipCategory[] = [
  { slug: "trendingmatches", title: "Trending Matches", description: "Today's most popular football fixtures — the matches trending with Tips180 punters and the tips going with them.", endpoint: "trendy", tipField: "trendytip", tier: "Free", gated: false },
  ...
  { slug: "bts", title: "Both Teams to Score", description: "BTTS (Both Teams to Score) tips — fixtures where we expect goals at both ends.", endpoint: "bts", tipField: "bts", marketLabel: "BTTS (GG)", tier: "Key", gated: true },
